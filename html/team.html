               ...
               <div class="container">
                  <div class="row d_flex">
                     ...
                     <div class="col-md-4 col-sm-4 " >
                        <a class="logo" href="#"><img src="images/logo1.png" alt="#"/></a>
                     </div>
                     <div class="col-md-4 col-sm-4 d_none">
                        <ul class="conta_icon ">
                           <li><a href="#"><i class="fa fa-envelope" aria-hidden="true"></i> eemis@gmail.com</a> </li>
                        </ul>
                     </div>
                  </div>
               </div>
      ...
      <footer >
         <div class="footer">
            <div class="container">
               <div class="row">
                  <div class="col-md-12">
                     <a class="logo2" href="#"><img src="images/logo1.png" alt="#" /></a>
                  </div>
                  <div class="col-lg-5 col-md-6 col-sm-6">
                     ...
                     <ul class="location_icon">
                        ...
                        <li><a href="#"><i class="fa fa-envelope" aria-hidden="true"></i></a>eemis@gmail.com<br></li>
            ...
            <div class="copyright">
               <div class="container">
                  <div class="row">
                     <div class="col-md-12">
                        <p>© 2022 All Rights Reserved.<a href="https://html.design/"> EEMIS</a></p>
                     </div>
                  </div>
               </div>
            </div>
